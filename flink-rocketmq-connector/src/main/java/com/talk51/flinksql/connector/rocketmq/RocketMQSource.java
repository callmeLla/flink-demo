...
import com.talk51.flinksql.connector.rocketmq.common.util.MetricUtils;
import com.talk51.flinksql.connector.rocketmq.common.util.RetryUtil;
import com.talk51.flinksql.connector.rocketmq.common.watermark.WaterMarkForAll;
import com.talk51.flinksql.connector.rocketmq.common.watermark.WaterMarkPerQueue;
import com.talk51.flinksql.connector.rocketmq.common.util.RocketMQUtils;
...
import static com.talk51.flinksql.connector.rocketmq.common.util.RocketMQUtils.getInteger;
import static com.talk51.flinksql.connector.rocketmq.common.util.RocketMQUtils.getLong;
...
public class RocketMQSource<OUT> extends RichParallelSourceFunction<OUT>
    ...
    private JSONKeyValueDeserializationSchema schema;
    ...
    public RocketMQSource(JSONKeyValueDeserializationSchema schema, Properties props, DeserializationSchema<RowData> deserializer) {
        this.schema = schema;
        this.props = props;
...
//                                            tpsMetric.markEvent();
                                            context.collect(deserializer.deserialize(value));
                                        }
                                    }
                                    found = true;
                                    break;
