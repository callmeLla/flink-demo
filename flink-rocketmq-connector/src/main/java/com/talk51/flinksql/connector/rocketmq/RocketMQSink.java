...
public class RocketMQSink<IN> extends RichSinkFunction<IN> implements CheckpointedFunction {
    ...
    public RocketMQSink(Properties props, SerializationSchema<RowData> serializer, String topic, String tag) {
        this.props = props;
    ...
    public void invoke(IN input, Context context) throws Exception {
        ...
        /** 解析报文内容并转为byte[] */
        RowData in = (RowData)input;
        byte[] serialize = serializer.serialize(in);
        sinkInTps.markEvent();

//        Message msg = (Message) input;

//        String str = "{\"logtime\": \"xxx\",\"sign\": \"测试测试\",\"version\": \"C\"}";
        /** 拼装Message */
        Message msg = new Message(topic, tag==null?"defaultTag":tag, serialize);
